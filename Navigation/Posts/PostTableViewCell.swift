...
class PostTableViewCell: UITableViewCell {
    ...
    private var modelPostFull = PostModel(author: "", description: "", image: UIImage(named:"Ekat")!, likes: 1, view: 1)
   // private var modelPostFull = PostModel(author: "", description: "", image: UIImage(named:"didi")!, likes: 1, view: 1)
